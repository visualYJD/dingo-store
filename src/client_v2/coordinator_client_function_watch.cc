...
//                         const std::string& key, int64_t start_revision, bool need_prev_kv, bool no_put, bool
//                         no_delete, bool wait_on_not_exist_key, std::vector<dingodb::pb::version::Event>& events) {
//   dingodb::pb::version::WatchRequest request;
//   dingodb::pb::version::WatchResponse response;
